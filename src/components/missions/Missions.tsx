...
interface Mission {
  // Define the shape of a Mission object
  // e.g. title, description, imageSrc
  title: string;
  description: string;
  imgUrl: string;
}
...
const Missions: React.FC = () => {
  return (
    <section className="mission" id="missions">
      <Container>
        <Row>
          <Col size={12}>
            <TrackVisibility>
              {({ isVisible }) => (
                ...
                >
                  <h2>Missions</h2>
                  <p>
                    NASA's James Webb Space Telescope has captured the first
                    clear evidence for carbon dioxide in the atmosphere of a
                    planet outside the solar system. This observation of a gas
                    giant planet orbiting a Sun-like star 700 light-years away
                    provides important insights into the composition and
                  ...
                  <Tab.Container id="missions-tabs" defaultActiveKey="first">
                    ...
                    >
                      ...
                      <Tab.Pane eventKey="secend">
                        <p>
                          The James Webb Space Telescope will find the first
                          galaxies that formed in the early universe and peer
                          through dusty clouds to see stars forming planetary
                          systems
                        </p>
                      </Tab.Pane>
